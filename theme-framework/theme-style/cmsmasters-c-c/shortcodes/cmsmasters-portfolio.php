...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Projects', 'see-my-cv');

$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'see-my-cv');

$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'see-my-cv');

$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'see-my-cv');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'see-my-cv');
