...
if ($button_show == 'true') {
	...
	if ($button_custom_styles == 'true') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . '.cmsmasters_pricing_item { ' . 
			(($button_line_height != '') ? "\n\t" . 'padding-bottom:' . esc_attr($button_line_height / 2) . 'px; ' : '') . 
		"\n" . '} ' . "\n";
		
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_pricing_item_content_wrap { ' . 
			(($button_line_height != '') ? "\n\t" . 'margin-bottom:' . esc_attr((-$button_line_height / 2) + 40) . 'px; ' : '') . 
		"\n" . '} ' . "\n";
		...
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_button { ' . 
			...
			(($button_line_height != '') ? "\n\t" . 'bottom:-' . esc_attr($button_line_height / 2) . 'px; ' : '') . 
...
'>' . "\n" . 
	'<div class="cmsmasters_pricing_item_inner">' . "\n" . 
		'<div class="cmsmasters_pricing_item_content_wrap">' . "\n" . 
