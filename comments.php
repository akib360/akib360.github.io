...
$form_fields =  array( 
	'author' => '<p class="comment-form-author">' . "\n" . 
		'<input type="text" id="author" name="author" value="' . esc_attr($commenter['comment_author']) . '" size="35"' . ((isset($aria_req)) ? $aria_req : '') . ' placeholder="' . esc_attr__('Your name', 'see-my-cv') . (($req) ? ' *' : '') . '" />' . "\n" . 
	'</p>' . "\n", 
	'email' => '<p class="comment-form-email">' . "\n" . 
		'<input type="text" id="email" name="email" value="' . esc_attr($commenter['comment_author_email']) . '" size="35"' . ((isset($aria_req)) ? $aria_req : '') . ' placeholder="' . esc_attr__('Your email', 'see-my-cv') . (($req) ? ' *' : '') . '" />' . "\n" . 
	'</p>' . "\n", 
	'cookies' => '<p class="comment-form-cookies-consent">' . "\n" . 
		...
		'<label for="wp-comment-cookies-consent">' . esc_html__('Save my name, email, and website in this browser for the next time I comment.', 'see-my-cv') . '</label>' . "\n" . 
	'</p>' . "\n" 
);
...
comment_form(array( 
	...
	'comment_field' => 		'<p class="comment-form-comment">' . 
								'<textarea name="comment" id="comment" cols="67" rows="2" placeholder="' . esc_attr__('Comment', 'see-my-cv') . '"></textarea>' . 
							'</p>', 
	...
	'id_form' => 				'commentform', 
	'id_submit' => 				'submit', 
	'title_reply' => 			esc_html__('Leave a Reply', 'see-my-cv'), 
	'title_reply_to' => 		esc_html__('Leave your comment to', 'see-my-cv'), 
	'cancel_reply_link' => 		esc_html__('Cancel Reply', 'see-my-cv'), 
	'label_submit' => 			esc_html__('Add Comment', 'see-my-cv') 
));
