...
if (CMSMASTERS_LEARNPRESS) {
	...
	function see_my_cv_change_template_for_learnpress() {
		return 'learnpress/cmsmasters-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/templates';
	}
	
	add_filter('learn_press_template_path', 'see_my_cv_change_template_for_learnpress');
}
...
if (!function_exists('see_my_cv_load_theme_textdomain')) {
	function see_my_cv_load_theme_textdomain() {
		load_theme_textdomain('see-my-cv', get_template_directory() . '/theme-vars/languages');
	}
}
