...
function see_my_cv_get_admin_page() {
	global $pagenow;
...
function see_my_cv_default_tab() {
	$current_page = see_my_cv_get_admin_page();
...
function see_my_cv_get_the_tab() {
	global $pagenow;
	
	$default_tab = see_my_cv_default_tab();
...
function see_my_cv_settings_page_header() {
