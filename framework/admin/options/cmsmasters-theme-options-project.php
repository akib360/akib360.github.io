...
if (!function_exists('see_my_cv_get_custom_project_meta_fields')) {
function see_my_cv_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['see-my-cv' . '_portfolio_project_title']) && $cmsmasters_option['see-my-cv' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['see-my-cv' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['see-my-cv' . '_portfolio_project_details_title']) && $cmsmasters_option['see-my-cv' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['see-my-cv' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['see-my-cv' . '_portfolio_project_share_box']) && $cmsmasters_option['see-my-cv' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['see-my-cv' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['see-my-cv' . '_portfolio_project_author_box']) && $cmsmasters_option['see-my-cv' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['see-my-cv' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['see-my-cv' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['see-my-cv' . '_portfolio_more_projects_box'] : 'related';
	
	$cmsmasters_proportion = see_my_cv_project_puzzle_proportion();
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'see-my-cv'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Project', 'see-my-cv'), 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'see-my-cv'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'see-my-cv'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'see-my-cv'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'see-my-cv'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Project Title', 'see-my-cv'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image Size', 'see-my-cv'), 
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio', 'see-my-cv') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image', 'see-my-cv'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects', 'see-my-cv'), 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'see-my-cv'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'see-my-cv') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'see-my-cv'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'see-my-cv'), 
			'desc'	=> esc_html__('Open link in a new tab', 'see-my-cv'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'see-my-cv'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'see-my-cv'), 
			'desc'	=> '', 
