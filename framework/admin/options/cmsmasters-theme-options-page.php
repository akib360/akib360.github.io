...
if (!function_exists('see_my_cv_get_custom_page_meta_fields')) {
function see_my_cv_get_custom_page_meta_fields() {
	$cmsmasters_option = see_my_cv_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['see-my-cv' . '_layout']) && $cmsmasters_option['see-my-cv' . '_layout'] !== '') ? $cmsmasters_option['see-my-cv' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['see-my-cv' . '_header_overlaps']) && $cmsmasters_option['see-my-cv' . '_header_overlaps'] !== '') ? (($cmsmasters_option['see-my-cv' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'see-my-cv'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'see-my-cv'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'see-my-cv'), 
